...
public static final List<String>EXPECTED_MYACC_ORDER_LIST=Arrays.asList("View your order history","Downloads","Your Reward Points","View your return requests","Your Transactions","Recurring payments");
...
public static final List<String>EXPECTED_NEWSLETTER_HEADER_OPTION_LIST=Arrays.asList("Subscribe / unsubscribe to newsletter");
}